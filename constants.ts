...
// ═══════════════════════════════════════ CHƯƠNG 6 ═══════════════════════════════════════
  ...
  // ═══════════════════════════════════════ CHƯƠNG 7 ═══════════════════════════════════════
  createHero3('h7_1', 'Hồ Quý Ly', 80, 7, 'ally', 'Hoàng Đế', 'Nhà chính trị, nhà cải cách lớn táo bạo, người sáng lập nhà Hồ, chủ trương đổi mới toàn diện hệ thống tiền tệ, hạn điền, hạn nô và chính sách quân sự.', 'Tân Chính Đổi Mới', 'Gây 180% sát thương vật lý 1 mục tiêu hàng trên, bản thân nhận 20% Thủ và tăng 10% Công toàn đội trong 2 hiệp.', { role: 'Chiến tướng', targetScope: 'single', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 18 }),
  createHero3('h7_2', 'Hồ Hán Thương', 75, 7, 'ally', 'Hoàng Đế', 'Con thứ Hồ Quý Ly, vị vua thứ hai và cũng là cuối cùng của nhà Hồ, cùng triều đình gánh vác giai đoạn kháng chiến chống quân Minh đầy gian khó.', 'Nhà Hồ Mạt Vận', 'Gây 135% sát thương phép 3 mục tiêu hàng dưới, tạo Khiên ảo bằng 15% máu tối đa trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'back_row', skillEffect: 'shield', skillEffectChance: 100, skillDmgMult: 13.5 }),
  ...
  createHero2('h7_4', 'Trần Khát Chân', 78, 7, 'ally', 'Tướng quân', 'Trần Khát Chân là dũng tướng tài ba cuối nhà Trần, người đã đánh bại và giết chết vua Chế Bồng Nga của Chiêm Thành năm 1390 — kết thúc giai đoạn Chiêm Thành là mối đe dọa lớn nhất của Đại Việt. Ông sau đó mưu đồ chống Hồ Quý Ly và bị xử tử.', 'Bãi Trúc Phục Kích', 'Phục kích trong bụi rậm, đòn tấn công bất ngờ gây sát thương (156% Tấn công) cao. (Mục tiêu: 1 mục tiêu địch).', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_5', 'Trần Nguyên Hãn', 80, 7, 'ally', 'Tướng quân', 'Trần Nguyên Hãn là dũng tướng nhà hậu Trần, sau theo phò Lê Lợi trong khởi nghĩa Lam Sơn và lập nhiều chiến công. Ông chỉ huy trận Chi Lăng tiêu diệt Liễu Thăng. Tuy nhiên sau khi đất nước thống nhất, ông bị Lê Lợi nghi ngờ và giết hại.', 'Chi Lăng Hùng Phong', 'Chiến thuật địa hình sắc bén, gây sát thương (160% Tấn công) lên 1 mục tiêu địch..', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero3('h7_6', 'Trần Ngỗi', 75, 7, 'ally', 'Hoàng Đế', 'Giản Định Đế, vị vua khai mở triều đại nhà Hậu Trần, phất cao ngọn cờ khởi nghĩa chống ách đô hộ nhà Minh tại Ninh Bình trong những năm đầu thế kỷ XV.', 'Hậu Trần Phất Cờ', 'Gây 180% sát thương vật lý 1 mục tiêu hàng trên, nhận 15% Công và hồi 5% máu tối đa trong 2 hiệp.', { role: 'Đấu sĩ', targetScope: 'single', skillEffect: 'atk_up', skillEffectChance: 100, skillDmgMult: 18 }),
  createHero3('h7_7', 'Trần Quý Khoáng', 75, 7, 'ally', 'Hoàng Đế', 'Trùng Quang Đế, vị vua thứ hai của nhà Hậu Trần, người cùng các danh tướng lãnh đạo cuộc kháng chiến chống quân Minh kiên cường, bền bỉ đến hơi thở cuối cùng.', 'Trùng Quang Kháng Minh', 'Gây 135% sát thương phép 3 mục tiêu hàng dưới, đồng thời tăng 12% Phòng thủ toàn đội trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'back_row', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 13.5 }),
  createHero3('h7_8', 'Đặng Dung', 75, 7, 'ally', 'Danh Tướng', 'Đại danh tướng thời Hậu Trần, văn võ song toàn, người có khí phách hào hùng và là tác giả bài thơ Thuật hoài mang đậm hào khí Đông A bi tráng.', 'Thuật Hoài Hào Khí', 'Gây 140% sát thương vật lý 3 mục tiêu hàng trước, nhận 20% Thủ và phản 15% sát thương trong 2 hiệp.', { role: 'Chiến tướng', targetScope: 'front_row', skillEffect: 'reflect', skillEffectChance: 100, skillDmgMult: 14 }),
  createHero3('h7_9', 'Nguyễn Cảnh Chân', 85, 7, 'ally', 'Đại Thần', 'Đại thần trung nghĩa tận tụy, cột trụ vững chắc phò tá các vua nhà Hậu Trần trong công cuộc khôi phục giang sơn trước thế lực quân Minh.', 'Trung Nghĩa Phò Triều', 'Gây 140% sát thương phép 3 mục tiêu hàng dưới, tăng 12% Phòng thủ toàn đội trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'back_row', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 14 }),
  createHero2('h7_10', 'Nguyễn Suý', 67, 7, 'ally', 'Tướng quân', 'Tướng quân thời hậu Trần, có công trong các trận đánh chống quân Minh chiếm đóng.', 'Kỳ Binh Kỳ Trận', 'Dùng chiến thuật bất ngờ, gây sát thương (134% Tấn công) lên 1 mục tiêu địch..', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero3('h7_11', 'Nguyễn Phi Khanh', 65, 7, 'ally', 'Danh Sĩ', 'Đại danh sĩ, nhà thơ lớn và là thân phụ của Anh hùng dân tộc Nguyễn Trãi. Ông đỗ thái học sinh nhà Trần, nổi tiếng với tài văn chương và lòng trung nghĩa.', 'Ức Trai Phụ Thân', 'Gây 145% sát thương phép 1 hàng dọc, tăng 10% Tấn công bản thân và đồng minh cùng hàng trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'column', skillEffect: 'atk_up', skillEffectChance: 100, skillDmgMult: 14.5 }),
  createHero3('h7_12', 'Đặng Tất', 85, 7, 'ally', 'Quốc Công', 'Quốc công nhà Hậu Trần, người cha tài ba cùng con trai lập công đầu trong trận Bô Cô đại phá quân Minh, là chỗ dựa quân sự vững chắc thời kỳ đầu Hậu Trần.', 'Bô Cô Đại Phá', 'Gây 180% sát thương vật lý 1 mục tiêu hàng trên, bản thân nhận 20% Thủ và tăng 10% Công trong 2 hiệp.', { role: 'Chiến tướng', targetScope: 'single', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 18 }),
  createHero3('h7_13', 'Nguyễn Cảnh Dị', 75, 7, 'ally', 'Danh Tướng', 'Danh tướng kiệt xuất nhà Hậu Trần, nổi tiếng với khí tiết kiên cường, khi bị giặc Minh bắt đã hiên ngang mắng mỏ rồi tuẫn tiết đến cùng.', 'Trung Liệt Tuẫn Tiết', 'Gây 180% sát thương vật lý 1 mục tiêu hàng trên, miễn khống chế và tăng 15% Công trong 2 hiệp.', { role: 'Đấu sĩ', targetScope: 'single', skillEffect: 'atk_up', skillEffectChance: 100, skillDmgMult: 18 }),
  createHero3('h7_14', 'Hồ Tông Thốc', 75, 7, 'ally', 'Đại Thần', 'Đại thần, danh sĩ tài năng dưới triều nhà Hồ, người tích cực tham gia vào các công việc chính sự và cải cách hành chính của triều đình.', 'Cải Cách Xã Thắc', 'Gây 145% sát thương phép 1 hàng dọc, giảm 10% Phòng thủ mục tiêu trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'column', skillEffect: 'def_down', skillEffectChance: 100, skillDmgMult: 14.5 }),
  createHero3('h7_15', 'Lê Cảnh Kỳ', 55, 7, 'ally', 'Tướng Lĩnh', 'Tướng lĩnh trung thành của nhà Hồ, người cùng các tướng chịu chung số phận bị giặc Minh bắt giải về Trung Hoa sau khi triều đại sụp đổ.', 'Cận Thần Tuẫn Quốc', 'Gây 80% sát thương vật lý 3 mục tiêu hàng trước, tăng 5% Phòng thủ bản thân trong 1 hiệp.', { role: 'Chiến tướng', targetScope: 'front_row', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 8 }),
  createHero2('h7_16', 'Nguyễn Bằng', 51, 7, 'ally', 'Hào kiệt', 'Hào kiệt yêu nước thời chống Minh thuộc, tham gia nhiều cuộc nổi dậy nhỏ lẻ.', 'Dân Binh Chiêu Mộ', 'Chiêu mộ dân binh yêu nước, gây sát thương (102% Tấn công) lên 1 mục tiêu địch..', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_17', 'Vũ Công Khanh', 52, 7, 'ally', 'Tướng quân', 'Tướng quân thời chống Minh, có tài chỉ huy quân sự và chiến thuật.', 'Khinh Binh Đột Phá', 'Dùng khinh binh nhanh nhẹn phá vỡ hàng phòng thủ (+15%).', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_18', 'Bùi Quý Hựu', 53, 7, 'ally', 'Hào kiệt', 'Hào kiệt thời Minh thuộc, chiến đấu bảo vệ dân làng khỏi sự tàn bạo của quân xâm lược.', 'Thôn Làng Thủ Vệ', 'Bảo vệ thường dân cho toàn đội (+15% Phòng thủ).', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_19', 'Phạm Lực', 51, 7, 'ally', 'Hào kiệt', 'Hào kiệt thời kháng Minh, tham gia chiến đấu chống lại ách cai trị tàn bạo.', 'Tự Do Chiến Đấu', 'Đánh vì tự do, tinh thần không bị bó buộc. (+20 Nhuệ khí).', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_20', 'Nguyễn Nhữ Cái', 55, 7, 'ally', 'Tướng quân', 'Tướng quân tham gia kháng chiến chống Minh trong những năm đầu Minh thuộc.', 'Hậu Cần Dũng', 'Bảo vệ tuyến hậu cần, gây sát thương (110% Tấn công) lên 1 mục tiêu địch..', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero2('h7_21', 'Hồ Nhan', 50, 7, 'ally', 'Hào kiệt', 'Hào kiệt thời Minh thuộc, dũng cảm chống lại sự bóc lột của quan lại phương Bắc.', 'Phản Kháng', 'Vùng lên bất ngờ, gây sát thương (100% Tấn công) lớn cho kẻ thống trị. (Mục tiêu: 1 mục tiêu địch).', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  createHero3('h7_22', 'Trần Nguyên Đán', 85, 7, 'ally', 'Tôn Thất', 'Tôn thất nhà Trần, đại thần uyên bác, nhà thơ và nhà chiêm tinh lỗi lạc, người ông ngoại đáng kính hết lòng dạy dỗ danh nhân Nguyễn Trãi từ thuở nhỏ.', 'Thiên Văn Thấu Triệt', 'Gây 140% sát thương phép 3 mục tiêu hàng dưới, tăng 12% Tốc độ toàn đội trong 2 hiệp.', { role: 'Hỗ trợ', targetScope: 'back_row', skillEffect: 'spd_up', skillEffectChance: 100, skillDmgMult: 14 }),
  createHero3('h7_23', 'Nguyễn An', 75, 7, 'ally', 'Kỳ Tài', 'Thiên tài kiến trúc và kỹ thuật người Việt thời đầu thế kỷ XV, kiến trúc sư trưởng thiết kế và chỉ đạo xây dựng quần thể Tử Cấm Thành (Bắc Kinh, Trung Quốc) lừng danh thế giới.', 'Kỳ Tài Kiến Trúc', 'Gây 145% sát thương phép 1 hàng dọc, tăng 15% Phòng thủ bản thân trong 2 hiệp.', { role: 'Pháp sư', targetScope: 'column', skillEffect: 'def_up', skillEffectChance: 100, skillDmgMult: 14.5 }),
  ...
  createHero2('h8_19', 'Đinh Công Trứ', 65, 8, 'ally', 'Danh tướng', 'Danh tướng thời 8.', 'Dũng Mãnh', 'Gây 100% sát thương lên 1 mục tiêu.', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
  ...
  createHero2('h8_22', 'Lê Thứ', 51, 8, 'ally', 'Tướng quân', 'Lê Thụ là tướng quân trung thành trong khởi nghĩa Lam Sơn, chuyên phòng thủ căn cứ địa.', 'Căn Cứ Địa Vững Chắc', 'Bảo vệ căn cứ, gây sát thương (102% Tấn công) lên 1 mục tiêu địch..', 'Gây sát thương vật lý lên 1 mục tiêu địch hàng trước.'),
